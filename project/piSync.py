...
try:
	if(condition  == "upload"):
		mystr = ("scp -r -p /home/diosz/Desktop/python-stepper-goto/project/ pi@"+str(ip)+":/home/pi/")
		os.system(mystr)
		...
		if(a!="yes" or a!="y" or a!= "Yes" or a!="YES"):
			exit()
		mystr = ("scp -r -p pi@"+str(ip)+":/home/pi/project /home/diosz/Desktop/python-stepper-goto")
		os.system(mystr)
except:
